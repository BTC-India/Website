      ...
      <div className="relative metadata flex flex-col items-start gap-4 w-fit sm:w-[448px] text-wrap  h-full">
        <div className="heading-publisheddate-readingtime w-fit h-fit flex flex-col gap-2">
          ...
          <div className="publish-date flex flex-row gap-2 items-center w-fit h-fit">
            <BsCalendar2Date className="text-base text-neutral-800" />
          ...
          <div className="title-and-description flex flex-col text-wrap gap-1 w-fit h-fit">
            <Link href={`/blog/${cardData.slug}`}>
              <div className="title font-bold text-neutral-800 text-xl sm:text-2xl duration-200 hover:text-orange-700">
                {cardData.title} {/* Blog post title */}
              </div>
            </Link>
            <div className="description text-neutral-700">
