...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      siteName: `BTC India`, // Site name for OpenGraph
  ...
  const sharingConfig: SharingLinkConfigProps = [
    {
      ...
      className: "hover:text-green-600", // WhatsApp sharing link
    },
    {
      name: "Mail",
      ...
      className: "hover:text-blue-500", // Email sharing link
    },
    {
      name: "Twiiter (X)",
      icon: FaXTwitter,
      ...
      className: "hover:text-neutral-700", // Twitter sharing link
    },
    {
      name: "Linkedin",
      icon: FaLinkedinIn,
      ...
      className: "hover:text-blue-500", // LinkedIn sharing link
    },
    {
      name: "Facebook",
      icon: FaFacebookF,
      ...
      className: "hover:text-blue-700", // Facebook sharing link
    },
  ];
      ...
      <div className="wrapper w-full h-fit max-w-screen-xl flex items-center justify-center">
        <article className="post p-2 flex flex-col gap-6 w-[900px] h-fit items-center justify-center">
            ...
            <div className="content w-full h-fit items-start justify-start p-1 flex flex-col gap-2">
              <div className="date-and-read-and-title flex flex-col">
                <div className="date-and-read flex flex-row gap-1 text-sm sm:text-base">
                  <div className="w-fit h-fit date flex flex-row gap-1 items-center text-neutral-700">
                  ...
                  <div className="w-fit h-fit read-time text-neutral-700">
                    {readTimeDisText} {/* Display calculated reading time */}
                  </div>
                </div>
                <div className="title font-bold text-2xl lg:text-5xl text-neutral-800 ">
                  {blogData.title} {/* Display blog title */}
                </div>
              </div>
              <div className="description text-xl text-neutral-600">
          ...
          <section className="post-content-and-share h-fit w-fit flex flex-col gap-6">
            <div className="post-content text-base text-black sm:text-lg markdown">
            ...
            <div className="relative tags-and-share flex flex-row flex-wrap gap-6 w-full items-center justify-between">
              <div className="tags w-fit h-fit flex flex-row gap-2 items-center">
                {blogData.tags.map((tag: string, index: number) => (
                  <div
                    key={index}
                    className="tag px-2 py-1 bg-neutral-300 text-neutral-700 rounded-sm"
                  >
              ...
              <div className="share flex flex-row gap-2 w-fit h-fit items-center">
                <div className="text-share w-fit h-fit text-neutral-500 font-semibold text-base sm:text-lg">
                  Share:
                </div>
                <div className="share-link-wrapper flex flex-row gap-2 w-fit h-fit">
                  {sharingConfig.map((share, index) => (
                    ...
                    >
                      <share.icon
                        className={`text-lg text-neutral-500 ${share.className} w-fit h-fit duration-300`}
                      />
                    </Link>
                  ))}
                </div>
            ...
            <div className="back-button w-fit mt-6">
              <button className="w-fit h-fit hover:bg-yellow-400  px-3 py-3 duration-300 rounded-3xl group">
                <Link
                  href={"/blog"} // Link to navigate back to the blog list
                  className="flex flex-row w-fit h-fit items-center gap-1 group"
                >
                  <IoChevronBack className="text-neutral-700 hover:text-neutral-800 group-hover:-translate-x-1 duration-300" />
                  <span className="text-neutral-700 hover:text-neutral-800 w-fit h-fit duration-300 ">
